...
//go:generate mockgen -source remote_client.go -destination mock_remote_client.go -self_package github.com/xiaojiaoyu100/rocketmq-client-go/internal/remote  --package remote RemotingClient
