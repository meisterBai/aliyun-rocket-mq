...
//go:generate mockgen -source client.go -destination mock_client.go -self_package github.com/xiaojiaoyu100/rocketmq-client-go/internal  --package internal RMQClient
