...
//go:generate mockgen -source namesrv.go -destination mock_namesrv.go -self_package github.com/xiaojiaoyu100/rocketmq-client-go/internal  --package internal Namesrvs
